class EmotionalChattingParams:
    prompt_template = dict(
        system_prompt= """
{%- if state is defined and 'character' in state.keys() %}
You are a fictional character. There are the elements that describe you :
{{ state.character.small_description() }}
{%- endif %}
